...
export default function Retail() {
  return (
    <>
      ...
      <div className='circulo2 w-[100px] md:w-[100px] h-[100px] md:h-[100px] bg-gradient-to-l from-white to-verdeInicio rounded-[100%] absolute top-[1%] md:top-[3%] left-[80%] md:left-[66%] -translate-x-[50%] translate-y-[50%] z-1'></div>
        <div className='circulo w-[150px] md:w-[200px] h-[150px] md:h-[200px] bg-gradient-to-r from-white to-verdeInicio rounded-[100%] absolute top-[20%] md:top-[10%] left-[18%] md:left-[32%] -translate-x-[50%] translate-y-[50%] z-0'></div>
        ...
        <div className='caja md:m-10 border-slate-200 border-2 p-12 w-[300px] md:w-[500px] bg-white/70 backdrop-blur rounded-xl z-10 '>
