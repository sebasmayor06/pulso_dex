...
export default function Retail() {
  return (
    <div className=' border-b-2 border-gray-400 shadow-xl'>
      ...
      <div className='circulo2 w-[100px] md:w-[100px] h-[100px] md:h-[100px] bg-gradient-to-l from-white to-verdeInicio rounded-[100%] absolute top-[18%] md:top-[20%] left-[85%] md:left-[66%] -translate-x-[50%] translate-y-[50%] z-1'></div>
